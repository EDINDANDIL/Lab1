...
Если формат данных не подходит, программа выводит сообщение об этом.
...
3. **Решение неравенства:**
   ...
   Смотрит еще три случая: где a-ноль, или противоположное событие, где еще одно условие (корень числителя отрицательный?)
   и противоположное ему (т.е. корень положительный). Затем неравенство решается по методу интервалов, x = 0 - выколотая точка, отмечается корень (его положение относительно x известно, так как мы попадаем в какой-то конкретный случай)
